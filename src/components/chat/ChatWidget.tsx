  ...
  return (
    <>
      <button
        ...
        className={cn(
          "group fixed right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-moss-deep text-bone shadow-lg transition-all duration-300 hover:scale-105 motion-reduce:transition-none md:right-6 md:h-14 md:w-14",
