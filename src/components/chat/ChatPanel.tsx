  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-end md:inset-auto md:bottom-24 md:right-6">
      ...
      <div
        ...
        className="relative flex h-[85vh] w-full flex-col overflow-hidden rounded-t-3xl border border-border/60 bg-card shadow-editorial md:h-[560px] md:w-[380px] md:rounded-3xl"
      >
        ...
        <footer className="border-t border-border/60 p-3">
          ...
          >
            <textarea
              ...
              className="max-h-28 flex-1 resize-none rounded-2xl border border-border bg-background px-3 py-2 text-sm outline-none focus:border-foreground disabled:opacity-60"
            />
