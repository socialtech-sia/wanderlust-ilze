...
function IconField({
  ...
  return (
    <div
      className={`flex ${align === "start" ? "items-start pt-3" : "items-center"} gap-2 rounded-xl border border-border bg-background px-4 transition-colors focus-within:border-foreground`}
    >
