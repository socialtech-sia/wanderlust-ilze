  ...
  return (
    <div className="container-editorial py-16 md:py-24">
      ...
      <div className="mt-10 grid gap-10 md:grid-cols-[minmax(0,1fr)_320px]">
        <form onSubmit={submit} className="grid gap-4 rounded-2xl border border-border/60 bg-card p-6 md:p-8">
          {state === "sent" ? (
            <p className="rounded-lg bg-moss-soft px-4 py-3 text-moss-deep">{t("contact.sent")}</p>
          ) : (
            <>
